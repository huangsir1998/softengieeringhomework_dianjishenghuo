    ...
    <form method="post" action="/auth/login">
        ...
        <c:if test="${ error_type != null }" >
            ...
            <input type="text" class="text-input
                   ...
                   value="${ sessionScope["flash_login_username"] }" placeholder="Username"/>
        </div>
        <div class="input-wrapper inline-input-wrapper
        <c:if test="${ error_type != null && param.error_type == \"INVALID_PASSWORD\" }" >
            ...
            <c:if test="${ error_type != null && param.error_type == \"INVALID_PASSWORD\" }" >
                ${ param.error_type == "INVALID_PASSWORD" ? "text-input-error" : "text-input-ok" }
                   ...
                   value="${ sessionScope["flash_login_password"] }" placeholder="Password"/>
        </div>
        <div class="input-wrapper inline-input-wrapper">
            <button type="submit" class="basic-button login-button">log in</button>
        </div>
    </form>
</div>
